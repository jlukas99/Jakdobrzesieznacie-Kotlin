...
class GamesAdapterFirestore(@NonNull options: FirestoreRecyclerOptions<GamesItem>, private val listener: CountInterface) : FirestoreRecyclerAdapter<GamesItem, GamesAdapterFirestore.InviteHolder>(options) {
    ...
    override fun onBindViewHolder(@NonNull holder: InviteHolder, position: Int, @NonNull model: GamesItem) {

        db.document().get().addOnCompleteListener {
            ...
            if (it.isSuccessful && it.result != null){
                ...
                if(doc != null){
                    ...
                    holder.itemView.passa_count.text = "Znajomy jest na etapie: " + model.fStage.toString()
